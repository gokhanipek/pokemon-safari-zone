...
class SafariZone extends React.Component {
    ...
    constructor(props) {
      ...
      start(){
        ...
        this.state.randomPositions.map((name) => {
                ...
                <div className="justify-content-center">
                    <div className="col col-12 align-self-center">
                        <div className="bs-component">
                            <h3 className="font-weight-bold">Hello { this.props.userName ? this.props.userName : 'Stranger!' }</h3>
                            <p className="font-weight-bold">Round: <strong>{this.state.rounds}</strong> - Pokeballs: <strong>{this.state.pokeballsLeft}</strong></p>
                            <p className="font-weight-bold">Pokemons Catched: <strong>{this.state.catchedPokemons.length}</strong>.</p>
                            <div className="row">
                            {
...
export default connect(mapStateToProps)(SafariZone)
